...
namespace ShopParserApi.Services.Repositories
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        public async Task<IEnumerable<CompanyData>> GetAll()
        {
            ...
            return await connection.QueryAsync<CompanyData>("sp_GetAllCompanies",
        ...
        public async Task<CompanyData> GetByName(string name)
        {
            ...
            return await connection.QuerySingleOrDefaultAsync<CompanyData>("sp_GetCompanyByName", values,
                commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task<CompanyData> GetById(int id)
        {
            ...
            return await connection.QuerySingleOrDefaultAsync<CompanyData>("sp_GetCompanyById", values,
                commandType: CommandType.StoredProcedure);
        }

        public async Task Add(DateTime syncDate = new DateTime(), int? sourceId = null, string externalId = null,
            string name = null, string url = null, string jsonData = null,
            string jsonDateSchema = null, int companyState = 0)
        {
            ...
            await connection.ExecuteAsync("sp_AddCompany", values, commandType: CommandType.StoredProcedure);
        }

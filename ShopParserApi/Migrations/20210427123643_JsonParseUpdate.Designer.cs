...
namespace ShopParserApi.Migrations
{
    ...
    [Migration("20210427123643_JsonParseUpdate")]
    partial class JsonParseUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("companyParserApi.Models.ProductData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("companyParserApi.Models.companyData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("companyParserApi.Models.companySource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CategoryProductData", b =>
                {
                    ...
                    b.HasOne("companyParserApi.Models.ProductData", null)
                        .WithMany()
            ...
            modelBuilder.Entity("companyParserApi.Models.Helpers.ProductAttribute", b =>
                {
                    b.HasOne("companyParserApi.Models.ProductData", "Product")
            ...
            modelBuilder.Entity("companyParserApi.Models.ProductData", b =>
                {
                    b.HasOne("companyParserApi.Models.companyData", "company")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("companyParserApi.Models.companyData", b =>
                {
                    b.HasOne("companyParserApi.Models.companySource", "Source")
                        .WithMany("companys")
